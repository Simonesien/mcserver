...
Pass auch darauf auf, dass es den Benutzer und die Gruppe, unter der der Minecraft Server gestartet werden soll, überhaupt gibt (Kann in minecraft@.service geändert werden).
