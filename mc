...
enable_server() {
	...
	cat /dev/null > /home/pi/minecraft-server/session
	sudo systemctl enable /home/pi/minecraft-server/minecraft@.service
	sudo ln -s /home/pi/minecraft-server/minecraft@.service /etc/systemd/system/multi-user.target.wants/minecraft@$session.service
...
disable_server() {
	...
	sudo systemctl disable /home/pi/minecraft-server/minecraft@.service
	cat /dev/null > /home/pi/minecraft-server/session
}
